...
var urlC = undefined;
var date = "2016-03-29";		// must be updated to current date whenever run.
var jobid = "1068"  // must be updated to current date whenever run. 
var tableNames = [
{region : "EMEA",
...
{fileNamePrefix : "Israel",
region : "EMEA",
fileCntryName : "ISR"},

{fileNamePrefix : "Africa",
region : "EMEA",
fileCntryName : "AFRICA"},
